...
addSbtPlugin(dependency = "uk.gov.hmrc" % "sbt-auto-build" % "3.6.0")
addSbtPlugin(dependency = "uk.gov.hmrc" % "sbt-distributables" % "2.1.0")
addSbtPlugin(dependency = "com.typesafe.play" % "sbt-plugin" % "2.8.13")
...
addSbtPlugin(dependency = "com.timushev.sbt" % "sbt-updates" % "0.6.1")
